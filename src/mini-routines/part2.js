...
export const MINI_ROUTINES_PART2 = {
    ...
    'q_ignore': [
        ...
        'k': [ // Binaural Beats Demo
            ...
            { time: 0.0, type: 'binaural', baseFrequency: 200, targetBrainwave: 'gamma', duration: 5.0, volume: 0.5 },
            { time: 0.0, type: 'style', value: 2 },
            { time: 0.0, type: 'lerp', key: 'flowSpeed', value: 15.0, duration: 2.0 },
            { time: 5.0, type: 'text', message: 'Inducing Theta Waves (6Hz)', duration: 5.0 },
            { time: 5.0, type: 'binaural', baseFrequency: 150, targetBrainwave: 'theta', duration: 5.0, volume: 0.5 },
    ...
    'I': [ // Inflammatory Response (Histamine)
        ...
        { time: 0.5, type: 'immune_migration', target: 'frontal', intensity: 1.2, duration: 3.5 },
    ...
    'C': [ // Glial Cell Cleanup
        ...
        { time: 1.5, type: 'immune_migration', target: 'frontal', intensity: 1.8, duration: 4.5 },
